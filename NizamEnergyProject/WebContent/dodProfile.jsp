...
<body>
	...
	<%
		...
		if (bean == null) {
			...
			ArrayList<SalesManBean> Salesmanlist = SalesmanBAL
					.getDistrictSalesman(dist_id);
			ArrayList<HashMap<String, String>> list = FieldOfficerBAL
					.getFieldOfficers(dist_id);

			String primary = UserBAL.getFormattedPhoneNumber(do_officer
					.getPhone());
			String secondary_phone = UserBAL
					.getFormattedPhoneNumber(do_officer
							.getSecondary_phone());
			String refferal_number1 = UserBAL
					.getFormattedPhoneNumber(do_officer
							.getRefferal_number1());
			String refferal_number2 = UserBAL
					.getFormattedPhoneNumber(do_officer
							.getRefferal_number2());
	%>
								...
								<table id="data-table" class="table table-hover table-bordered">
									...
									<tbody>
										...
										<tr class="link"
											...
											<td>
												<%
													String foNumber2 = UserBAL.getFormattedPhoneNumber(list
																	.get(i).get("foPhone"));
												%> <%=foNumber2%>
											</td>
