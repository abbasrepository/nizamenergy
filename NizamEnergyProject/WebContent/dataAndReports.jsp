			...
			<div class="row" style="padding-top: 2%;">
				...
				<div class="row well">
					...
					<div class="row well">
						...
						<div class="row">
							<form method="get" action="LateAndDefaulterList">
								<label class="control-label col-md-2"><b> Current
										Recovery Rate Data</b> </label>
								<div class="col-md-2">
									<select class="form-control" name="category">
										<option value="DO">District Officer</option>
										<option value="FO">Field Officer</option>
								...
								<div class="col-md-2">
									<button type="submit" class="btn btn-success btn-sm pull-left"
										name="click" id="click" value="Current Recovery Report">
										<b>Generate Current Recovery Report</b>
									</button>
								</div>
