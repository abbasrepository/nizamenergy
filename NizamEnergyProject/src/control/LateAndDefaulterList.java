		...
		if (action.equals("Generate Late and Defaulter Report")) {
			...
			if (category.equals("DO")) {
				...
				HSSFSheet sheet = workbook
						.createSheet("LateAndDefaulterofDistrict");
				...
				response.setHeader("Content-Disposition",
						"attachment; filename=LateAndDefaulterofDistrict.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("FO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				HSSFSheet sheet = workbook
						.createSheet("LateAndDefaulterofFieldOfficer");
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=LateAndDefaulterofFieldOfficer.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("customer")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				HSSFSheet sheet = workbook
						.createSheet("LateAndDefaulterCustomersList");
				Row header = sheet.createRow(0);
				...
				for (int i = 0; i < list.size(); i++) {
					...
					dataRow.createCell(1).setCellValue(
							list.get(i).get("remaining_days"));
					dataRow.createCell(2).setCellValue(
							list.get(i).get("customerName"));
					dataRow.createCell(3).setCellValue(
							list.get(i).get("customerNumber"));
					dataRow.createCell(4).setCellValue(
							list.get(i).get("NdName"));
					dataRow.createCell(5).setCellValue(
							list.get(i).get("NdNumber"));
					dataRow.createCell(6).setCellValue(
							list.get(i).get("foName"));
					dataRow.createCell(7).setCellValue(
							list.get(i).get("foNumber"));
					dataRow.createCell(8).setCellValue(
							list.get(i).get("doName"));
					dataRow.createCell(9).setCellValue(
							list.get(i).get("doNumber"));
				}
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=LateAndDefaulterCustomersList.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			}
			...
			if (category.equals("DO")) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					dataRow.createCell(1).setCellValue(
							list.get(i).get("district"));
					dataRow.createCell(2).setCellValue(
							list.get(i).get("pending"));
					dataRow.createCell(3).setCellValue(
							list.get(i).get("accepted"));
					dataRow.createCell(4).setCellValue(
							list.get(i).get("varified"));
				}
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=DOLoanApplicationsReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("FO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=FOLoanApplicationsReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			}
			...
			if (category.equals("DO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				HSSFSheet sheet = workbook
						.createSheet("DistrictOfficerSalesAverage");
				...
				for (int i = 0; i < list.size(); i++) {
					...
					dataRow.createCell(1).setCellValue(
							list.get(i).get("district"));
					dataRow.createCell(2).setCellValue(
							list.get(i).get("handover"));
					dataRow.createCell(3).setCellValue(
							list.get(i).get("average"));
				}
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=DistrictOfficerSalesAverage.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("FO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				HSSFSheet sheet = workbook
						.createSheet("FieldOfficerSalesAverage");
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=FieldOfficerSalesAverage.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=NizamDostSalesAverage.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			}
		} else if (action.equals("Generate Loan Apps Report")) {
			...
			response.setContentType("application/vnd.ms-excel");
			response.setHeader("Content-Disposition",
					"attachment; filename=LoanApplicationsReport.xls");
			workbook.write(response.getOutputStream());
			response.getOutputStream().flush();
			...
			if (category.equals("FO")) {
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=TopFOReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("ND")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=TopNDReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			}
			...
			if (category.equals("DO")) {
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=DoCreditScoreReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("FO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=FOCreditScoreReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("ND")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=NdCreditScoreReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("Customer")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=CustomerCreditScoreReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			}
		} else if (action.equals("Current Recovery Report")) {
			String category = request.getParameter("category");
			if (category.equals("DO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				HSSFSheet sheet = workbook.createSheet("Recovery Rate");
				Row header = sheet.createRow(0);
				header.createCell(0).setCellValue("DO Name");
				header.createCell(1).setCellValue("Recovery Rate");
				ArrayList<HashMap<String, String>> list = null;
				list = DataAndReportsBal.getDoRecovery();
				for (int i = 0; i < list.size(); i++) {
					Row dataRow = sheet.createRow(i + 1);
					dataRow.createCell(0).setCellValue(
							list.get(i).get("doName"));
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=DoRecoveryReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			} else if (category.equals("FO")) {
				HSSFWorkbook workbook = new HSSFWorkbook();
				...
				header.createCell(2).setCellValue("rating");
				ArrayList<HashMap<String, String>> list = null;
				list = DataAndReportsBal.getFoRecovery();
				for (int i = 0; i < list.size(); i++) {
					Row dataRow = sheet.createRow(i + 1);
					dataRow.createCell(0).setCellValue(
							list.get(i).get("FoName"));
				...
				response.setContentType("application/vnd.ms-excel");
				response.setHeader("Content-Disposition",
						"attachment; filename=FoRecoveryReport.xls");
				workbook.write(response.getOutputStream());
				response.getOutputStream().flush();
			}
		}
